...
####                    First Function                                                  #####
####************************************************************************************#####
def printing(flow, liters, minute, temperature, power_energy, decimalPlaces=2):  # new_message, decimalPlaces=2):
...
def calcus(bytesValues, decimalPlacese=2):
    ...
    while True:
        ...
        try:
            ...
            pulses = 0
            printing(flow_rate, lits, minute, celsius, power_energy)
